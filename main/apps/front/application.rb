...
module Front
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['FRONT_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Front::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Front::Action is included
      ...
      # Configure the code that will yield each time Front::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Front::Assets::Helpers
      end
    end
